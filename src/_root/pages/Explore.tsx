...
const Explore = () => {
  ...
  const { data: searchedPost, isFetching: isSeachFetching } =
    useSearchPosts(deboucedValue);
  ...
  return (
    <div className="explore-container">
      ...
      <div className="lex flex-wrap gap-9 w-full max-w-5xl">
        {shouldShowSearchResults ? (
          <SearchResult />
        ) : shouldShowPosts ? (
